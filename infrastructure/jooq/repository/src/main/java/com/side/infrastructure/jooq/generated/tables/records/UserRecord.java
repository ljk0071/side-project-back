...
public class UserRecord extends UpdatableRecordImpl<UserRecord> {
     ...
     */
    public UserRecord(Long uniqueId, String userId, String password, String name, String phoneNumber, String email, UserStatus status, UserType type, String description, Instant createdAt, Long createdBy, Instant modifiedAt, Long modifiedBy) {
        super(User.USER);
