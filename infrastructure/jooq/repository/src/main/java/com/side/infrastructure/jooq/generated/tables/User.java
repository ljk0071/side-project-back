...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, Long> UNIQUE_ID = createField(DSL.name("unique_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "유저 고유 ID");

    /**
     * The column <code>test_db.user.user_id</code>. 유저 ID
     */
    public final TableField<UserRecord, String> USER_ID = createField(DSL.name("user_id"), SQLDataType.VARCHAR(50).nullable(false), this, "유저 ID");
     ...
     */
    public final TableField<UserRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(50), this, "이름");

    /**
     * The column <code>test_db.user.phone_number</code>. 핸드폰번호
     */
    public final TableField<UserRecord, String> PHONE_NUMBER = createField(DSL.name("phone_number"), SQLDataType.VARCHAR(15), this, "핸드폰번호");
     ...
     */
    public final TableField<UserRecord, UserStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(7).nullable(false), this, "상태", new AutoConverter<String, UserStatus>(String.class, UserStatus.class));

    /**
     * The column <code>test_db.user.type</code>. 타입
     */
    public final TableField<UserRecord, UserType> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(6).nullable(false).asEnumDataType(UserType.class), this, "타입");

    /**
     * The column <code>test_db.user.description</code>. 설명
     */
    public final TableField<UserRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "설명");
