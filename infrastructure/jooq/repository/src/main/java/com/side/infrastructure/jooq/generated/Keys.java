...
public class Keys {
    ...
    public static final UniqueKey<RoleHierarchyRecord> KEY_ROLE_HIERARCHY_PRIMARY = Internal.createUniqueKey(RoleHierarchy.ROLE_HIERARCHY, DSL.name("KEY_role_hierarchy_PRIMARY"), new TableField[] { RoleHierarchy.ROLE_HIERARCHY.HIGHER_ROLE, RoleHierarchy.ROLE_HIERARCHY.LOWER_ROLE }, true);
    ...
    public static final UniqueKey<UserRoleRecord> KEY_USER_ROLE_PRIMARY = Internal.createUniqueKey(UserRole.USER_ROLE, DSL.name("KEY_user_role_PRIMARY"), new TableField[] { UserRole.USER_ROLE.ROLE_ID, UserRole.USER_ROLE.USER_UNIQUE_ID }, true);
}
