...
public class Role extends TableImpl<RoleRecord> {
     ...
     */
    public final TableField<RoleRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false)
     ...
     */
    public final TableField<RoleRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR(30)
                                                                                                .nullable(false), this, "역할코드");
    /**
     * The column <code>test_db.role.name</code>. 역할명
     */
    public final TableField<RoleRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(50)
                                                                                                .nullable(false), this, "역할명");
    /**
     * The column <code>test_db.role.created_at</code>. 생성일시
     */
    public final TableField<RoleRecord, Instant> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0)
