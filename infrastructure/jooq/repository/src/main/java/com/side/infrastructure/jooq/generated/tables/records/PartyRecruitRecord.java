...
public class PartyRecruitRecord extends UpdatableRecordImpl<PartyRecruitRecord> {
     ...
     */
    public PartyRecruitRecord(Long id, Long revision, Long userUniqueId, String title, String contents, Integer maxMembers, YesNoDeleteStatus status, Instant createdAt, Long createdBy, Instant modifiedAt, Long modifiedBy, Instant deletedAt, Long deletedBy) {
        super(PartyRecruit.PARTY_RECRUIT);
