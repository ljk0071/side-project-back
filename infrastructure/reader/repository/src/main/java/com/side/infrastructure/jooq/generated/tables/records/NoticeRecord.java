...
public class NoticeRecord extends UpdatableRecordImpl<NoticeRecord> {
     ...
     */
    public NoticeRecord(Long id, Long revision, String title, String contents, Long viewCount, YesNoDeleteStatus status, Instant createdAt, Long createdBy, Instant modifiedAt, Long modifiedBy, Instant deletedAt, Long deletedBy) {
        super(Notice.NOTICE);
